...
//查询
exports.get = function(collectionName,filter,callback){//只有用ID表示的点需要创建查询
    mongodb.getCollection(collectionName,function(collection){
        collection.find(filter).toArray(function(err, docs) {
            if(err != null){
                return callback(err, docs);
...
//创建
exports.create = function(collectionName,filter,data,callback){//只有用ID表示的点需要创建
    mongodb.getCollection(collectionName,function(collection){
        collection.find(filter).toArray(function(err, docs) {
            if(err != null){
                return callback(err, docs);
...
//更新
exports.update = function(collectionName,filter,data,callback){//只有用ID表示的点需要创建查询
    mongodb.getCollection(collectionName,function(collection){
        collection.find(filter).toArray(function(err, docs) {
            if(err != null){
                return callback(err, doc);
...
*/
//统计信息
exports.updateEdgeCount = function(collectionName,filter,data,callback){//只有用ID表示的点需要创建查询
    mongodb.getCollection(collectionName,function(collection){
        collection.find(filter).toArray(function(err, docs) {
            if(err != null){
                return callback(err, doc);
